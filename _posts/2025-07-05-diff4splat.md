...
highlight: false
---
Deformable Gaussian Diffusion is a generalizable framework for controllable 4D scene generation from a single image using a video diffusion model. test